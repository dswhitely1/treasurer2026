...
// Non-null assertions are safe here - req.user is guaranteed by auth middleware, req.orgMembership by organization middleware
...
export const updateMemberRoleHandler: RequestHandler = async (
  req,
  res,
  next,
) => {
